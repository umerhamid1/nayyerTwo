								...
								<section class="card">
                                    ...
                                    <div class="card-body">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
                                                <asp:Label ID="lblCompanyId" runat="server" style="font-size:15px; font-weight: 700;" ></asp:Label>
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-sm-8">
											    <asp:TextBox ID="txtCompany_Contact" runat="server" class="form-control" placeholder="  03331234567" Width="275px"></asp:TextBox>
